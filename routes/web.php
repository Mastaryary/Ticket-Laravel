...
use App\Http\Controllers\TransactionController; // Pastikan import Controller Transaction
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['transaksi'])->group(function () {
    Route::post('/transaksi', [TransaksiController::class, 'addTransaksi']);
    Route::get('/transaksi/create', [TransaksiController::class, 'showTransaksiForm'])->name('transaksi.create');
});
